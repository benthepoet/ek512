...
def run():
    ...
    Element.create(document=document, element_type=circle_type, x=0, y=0, radius=50, stroke_width=1)
    
    document = Document.create(name='Second Document', owner=editor, width=640, height=480)
    Element.create(document=document, element_type=rect_type, x=0, y=0, width=200, height=100, stroke_width=1)
    ...
    Element.create(document=document, element_type=rect_type, x=48, y=32, width=48, height=48, stroke_width=1)
    Element.create(document=document, element_type=text_box_type, x=112, y=64, text='Hello World')
