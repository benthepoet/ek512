...
def run():
    ...
    Element.create(document=document, element_type=circle_type, x=0, y=0, radius=50)
    
    document = Document.create(name='Second Document', owner=editor, width=640, height=480)
    Element.create(document=document, element_type=rect_type, x=0, y=0, width=200, height=100)
    ...
    Element.create(document=document, element_type=rect_type, x=48, y=32, width=48, height=48)
